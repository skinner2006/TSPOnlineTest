...
<?php
	...
	<div class="panel-heading">
		...
		<a style="cursor:pointer" class="btn btn-success" onclick="cetak(<?php echo $perangkat['id']; ?>)"><i class='icon-print'></i>Print</a>
				...
				<tr>
					<td>
						<div class="row">
							...
							<div class="col-md-4" style="text-align: left;">
								<label class="control-label"><?php echo $perangkat['tgl_mulai_service'];?></label>
							</div>
						</div>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<div class="row">
							...
							<div class="col-md-4" style="text-align: left;">
								<label class="control-label"><?php echo $perangkat['progres'];?></label>
							</div>
						</div>
					</td>
				</tr>
...
function cetak(id){
	window.open("cetakLaporan.php?id=" + id);
}
